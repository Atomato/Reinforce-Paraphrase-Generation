...
START_DECODING = '<s>' # This has a vocab id, which is used at the start of every decoder input sequence
STOP_DECODING = '</s>' # This has a vocab id, which is used at the end of untruncated target sequences
